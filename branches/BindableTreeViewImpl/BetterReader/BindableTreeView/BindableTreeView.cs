...
namespace BindableTreeView
{
	...
	//Based on SloppyCode.UI.DragDropTreeView.  Modeified by Steve Kain to support data binding.

	#region BindableTreeView class
	/// <summary>
	...
	public class BindableTreeView : System.Windows.Forms.TreeView
	{
		...
		public TreeNodeIndex TreeNodeIndex
		{
			get
			{
		...
		private TreeNodeIndex treeNodeIndex;
		...
		/// <returns></returns>
		protected virtual bool dragIsValid(TreeNode dragNode, TreeNode targetNode)
		{
